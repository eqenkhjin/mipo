...
/**
 * AmLoginHistory filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 * @author     Mipo Team
 ...
 */
abstract class BaseAmLoginHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('am_login_history_filters[%s]');
