...
/**
 * AmMessage filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 * @author     Mipo Team
 ...
 */
abstract class BaseAmMessageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'created_user_id'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'sended_user_count' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'sended_user_count' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('am_message_filters[%s]');
  ...
  public function addAmUsersListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('AmUserMessageConn.user_id', $values)
    ;
  }
