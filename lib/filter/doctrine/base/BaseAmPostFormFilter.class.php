 ...
 */
abstract class BaseAmPostFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'topic_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('AmTopic'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('am_post_filters[%s]');
