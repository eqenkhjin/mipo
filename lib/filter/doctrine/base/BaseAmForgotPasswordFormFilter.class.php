...
/**
 * AmForgotPassword filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 * @author     Mipo Team
 ...
 */
abstract class BaseAmForgotPasswordFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('am_forgot_password_filters[%s]');
